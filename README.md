...
고비용의 방탈출 게임을 선뜻 고르는 것이 어려운 사용자들을 대상으로, 개인에게 맞는 방탈출 게임을 찾고 예약하는 전 과정을 쉽고 간편하게 도와주는 API 서비스

아래 명세서 상세 내용은 노션으로도 확인 가능합니다. ([Link 바로가기](https://boom-manatee-5d1.notion.site/7e071d1b0b5144f69bcd31eb73206228))
